...
psql --host localhost --username postgres --dbname postgres --file "$archive/schema.sql"
psql --host localhost --username postgres --dbname postgres --file "$archive/data.sql"
